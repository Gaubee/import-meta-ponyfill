  ...
  (() => {
    ...
    return (require, module) => {
      ...
      if (importMetaCache == null) {
        const importMeta: ImportMeta = Object.assign(Object.create(null), {
...
export let import_meta_ponyfill_esmodule = (Reflect.get(
  ...
  ((importMeta: ImportMeta) => {
    ...
    const importMetaWM = new WeakMap<object, ImportMeta>();
    ...
    import_meta_ponyfill_esmodule = (im: ImportMeta) => {
